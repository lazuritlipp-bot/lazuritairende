...
st.markdown(
    ...
    /* КРУГЛЫЕ ИКОНКИ для image_select */
    ...
    /* Кнопка "Свой промт" */
    div[data-testid="column"]:nth-child(1) button[key="custom_prompt_btn"] {
        ...
        box-shadow: 0 5px 14px rgba(0, 0, 0, 0.025) !important;
        transition: all 0.18s ease !important;
    }
    
    div[data-testid="column"]:nth-child(1) button[key="custom_prompt_btn"]:hover {
...
with col_left:
    ...
    # 4 круглые иконки через image_select
