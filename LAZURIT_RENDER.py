...
st.markdown("""
    ...
    .custom-header {
        ...
        min-height: 100px; /* Гарантирует высоту шапки */
    }
    
    /* РАЗМЕР ЛОГОТИПА - ТУТ МЫ ЕГО УВЕЛИЧИЛИ */
    .header-logo {
        height: 120px !important; /* Было 70px, стало 120px */
...
PROMPT_PRESETS = {
    ...
    "Аксессуары": f"Добавить кухонные аксесуары. {BASE_PHOTO_PROMPT}",
    "Свой промт": ""
}
