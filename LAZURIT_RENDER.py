    ...
    def check_password():
        ...
        if not st.session_state.authenticated:
            ...
            st.markdown(
                ...
                /* КАРТОЧКА ЛОГИНА - ТЕПЕРЬ СТРОГО БЕЛАЯ */
                ...
                /* СТИЛИЗАЦИЯ ПОЛЯ ВВОДА - СВЕТЛО-СЕРЫЙ ЦВЕТ */
                ...
                /* КНОПКА ВОЙТИ - ФИКСИРОВАННЫЙ РАЗМЕР И ЦВЕТ */
                ...
                div[data-testid="stForm"] [data-testid="stFormSubmitButton"] button {{
                    ...
                    padding: 0 45px !important; /* Ширина через отступы */
                    font-weight: 500 !important;
                    font-size: 16px !important;
                    border-radius: 12px !important;
                    width: auto !important; /* Не на всю ширину! */
                    margin-top: 15px !important;
                    box-shadow: 0 4px 10px rgba(241, 117, 129, 0.3);
                }}
    ...
    # ОСНОВНОЙ ЦВЕТ ФОНА ПРИЛОЖЕНИЯ ПОСЛЕ ВХОДА
    st.markdown("""
        <style>
